    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-purple-500/30 relative overflow-hidden">
            ...
            <div className="container max-w-5xl mx-auto py-12 px-4 relative z-10">
                <div className="text-center mb-16 space-y-6 animate-in slide-in-from-top-4 fade-in duration-700">
                    <div className="inline-flex items-center justify-center p-4 bg-indigo-500/10 rounded-3xl mb-4 border border-indigo-500/20 shadow-[0_0_30px_rgba(99,102,241,0.2)]">
                        <Swords className="h-12 w-12 text-indigo-400" />
                    </div>
                    <h1 className="text-5xl md:text-6xl font-black tracking-tight bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-sm">
                        BATTLE ARENA
                    </h1>
